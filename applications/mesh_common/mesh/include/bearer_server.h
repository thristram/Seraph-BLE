...
#ifndef __BEARER_SERVER_H__
#define __BEARER_SERVER_H__

/*! \addtogroup Bearer_Server
 * @{
 */
 ...
 */
/*----------------------------------------------------------------------------*/
extern CSRmeshResult BearerModelInit(CsrUint8 nw_id, CsrUint16 *group_id_list, CsrUint16 num_groups,
 ...
 * \param p_params Pointer to the message parameters of type
              \ref CSRMESH_BEARER_STATE_T
 *
 * \returns CSRmeshResult. Refer to \ref CSRmeshResult.
 */
/*----------------------------------------------------------------------------*/
extern CSRmeshResult BearerState(
                                  CsrUint8 nw_id,
                                  CsrUint16 dest_id,
                                  CsrUint8 ttl,
