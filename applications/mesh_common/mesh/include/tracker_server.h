...
#ifndef __TRACKER_SERVER_H__
#define __TRACKER_SERVER_H__

/*! \addtogroup Tracker_Server
 * @{
 */
 ...
 */
/*----------------------------------------------------------------------------*/
extern CSRmeshResult TrackerModelInit(CsrUint8 nw_id, CsrUint16 *group_id_list, CsrUint16 num_groups,
 ...
 * \param p_params Pointer to the message parameters of type
              \ref CSRMESH_TRACKER_FOUND_T
 *
 * \returns CSRmeshResult. Refer to \ref CSRmeshResult.
 */
/*----------------------------------------------------------------------------*/
extern CSRmeshResult TrackerFound(
                                  CsrUint8 nw_id,
                                  CsrUint16 dest_id,
                                  CsrUint8 ttl,
 ...
 * \param ttl TTL value with which the message needs to be sent.
 * \param p_params Pointer to the message parameters of type
              \ref CSRMESH_TRACKER_REPORT_T
 *
 * \returns CSRmeshResult. Refer to \ref CSRmeshResult.
 */
/*----------------------------------------------------------------------------*/
extern CSRmeshResult TrackerReport(
                                  CsrUint8 nw_id,
                                  CsrUint16 dest_id,
                                  CsrUint8 ttl,
