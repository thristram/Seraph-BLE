...
#ifndef __WATCHDOG_SERVER_H__
#define __WATCHDOG_SERVER_H__

/*! \addtogroup Watchdog_Server
 * @{
 */
 ...
 */
/*----------------------------------------------------------------------------*/
extern CSRmeshResult WatchdogModelInit(CsrUint8 nw_id, CsrUint16 *group_id_list, CsrUint16 num_groups,
 ...
 * \param ttl TTL value with which the message needs to be sent.
 * \param p_params Pointer to the message parameters of type
              \ref CSRMESH_WATCHDOG_INTERVAL_T
 *
 * \returns CSRmeshResult. Refer to \ref CSRmeshResult.
 */
/*----------------------------------------------------------------------------*/
extern CSRmeshResult WatchdogInterval(
                                  CsrUint8 nw_id,
                                  CsrUint16 dest_id,
                                  CsrUint8 ttl,
                                  CSRMESH_WATCHDOG_INTERVAL_T *p_params);

/*!@} */
#endif /* __WATCHDOG_SERVER_H__ */
