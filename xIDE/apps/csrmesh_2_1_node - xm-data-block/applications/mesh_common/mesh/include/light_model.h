...
/*! \brief Setting Light White level. */
typedef struct
{
    CsrUint8 level; /*!< \brief White level */
    CsrUint16 duration; /*!< \brief Time before light reaches desired level */
    CsrUint8 tid; /*!< \brief Transaction identifier. The TID, or transaction identifier field is an 8-bit integer that identifies a given message with a known transaction from a source device. */
} CSRMESH_LIGHT_SET_WHITE_T;

/*! \brief Setting Light White level. */
typedef struct
{
    CsrUint8 tid; /*!< \brief Transaction identifier. The TID, or transaction identifier field is an 8-bit integer that identifies a given message with a known transaction from a source device. */
} CSRMESH_LIGHT_GET_WHITE_T;
