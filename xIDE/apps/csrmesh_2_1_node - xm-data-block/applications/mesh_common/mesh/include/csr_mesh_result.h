...
#define CSR_MESH_RESULT_RADIO_BUSY                  ((CSRmeshResult) 0x000C)/*!<\brief  CSR Mesh Operation status radio busy */ 
#define CSR_MESH_RESULT_KEY_ALREADY_EXISTS          ((CSRmeshResult) 0x000D)/*!<\brief  CSR Mesh  Operation status key already present */ 
