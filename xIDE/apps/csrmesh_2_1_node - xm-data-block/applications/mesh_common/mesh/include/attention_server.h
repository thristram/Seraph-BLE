...
#ifndef __ATTENTION_SERVER_H__
#define __ATTENTION_SERVER_H__

/*! \addtogroup Attention_Server
 * @{
 */
 ...
 */
/*----------------------------------------------------------------------------*/
extern CSRmeshResult AttentionModelInit(CsrUint8 nw_id, CsrUint16 *group_id_list, CsrUint16 num_groups,
 ...
 * \param p_params Pointer to the message parameters of type
              \ref CSRMESH_ATTENTION_STATE_T
 *
 * \returns CSRmeshResult. Refer to \ref CSRmeshResult.
 */
/*----------------------------------------------------------------------------*/
extern CSRmeshResult AttentionState(
                                  CsrUint8 nw_id,
                                  CsrUint16 dest_id,
                                  CsrUint8 ttl,
