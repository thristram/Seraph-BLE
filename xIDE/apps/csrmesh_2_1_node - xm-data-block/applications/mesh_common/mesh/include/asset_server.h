...
#ifndef __ASSET_SERVER_H__
#define __ASSET_SERVER_H__

/*! \addtogroup Asset_Server
 * @{
 */
 ...
 */
/*----------------------------------------------------------------------------*/
extern CSRmeshResult AssetModelInit(CsrUint8 nw_id, CsrUint16 *group_id_list, CsrUint16 num_groups,
 ...
 * \param p_params Pointer to the message parameters of type
              \ref CSRMESH_ASSET_STATE_T
 *
 * \returns CSRmeshResult. Refer to \ref CSRmeshResult.
 */
/*----------------------------------------------------------------------------*/
extern CSRmeshResult AssetState(
                                  CsrUint8 nw_id,
                                  CsrUint16 dest_id,
                                  CsrUint8 ttl,
 ...
 * \param ttl TTL value with which the message needs to be sent.
 * \param p_params Pointer to the message parameters of type
              \ref CSRMESH_ASSET_ANNOUNCE_T
 *
 * \returns CSRmeshResult. Refer to \ref CSRmeshResult.
 */
/*----------------------------------------------------------------------------*/
extern CSRmeshResult AssetAnnounce(
                                  CsrUint8 nw_id,
                                  CsrUint16 dest_id,
                                  CsrUint8 ttl,
