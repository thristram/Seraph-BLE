...
#endif
{
	 ...
	 * the Bluetooth Specification v4 for details.
	 */
	/**** HCI Events *********************************************************/
    LM_EV_DISCONNECT_COMPLETE       = 0x05,
    LM_EV_ENCRYPTION_CHANGE         = 0x08,

    /*! \brief HCI Remote Version Info event. Refer to Volume 2 Part E
     * section 7.7.12 of the spec. See also LM_EV_REMOTE_USED_FEATURES_T.
     */
    LM_EV_REMOTE_VERSION_INFO       = 0x0C,

    LM_EV_COMMAND_COMPLETE          = 0x0E, /*!< \brief Not visible to applications. */
    LM_EV_COMMAND_STATUS            = 0x0F, /*!< \brief Not visible to applications. */
     ...
     *  module. Refer to Volume 2 Part E Section 7.7.65.1 of the spec.
     */
    LM_EV_CONNECTION_COMPLETE       = 0x3E,

    /*! \brief BLE Advertising Report meta event. Refer to Volume 2 Part E
     ...
     * Refer to Volume 2 Part E section 7.7.65.3 of the spec.
     * No application response to this event is required.
     */
    LM_EV_CONNECTION_UPDATE,

    /*! \brief BLE Remote Used Features meta event. Refer to Volume 2 Part
     ...
     * Security Manager module. Refer to Volume 2 Part E section 7.7.65.5
     * of the spec. No application response to this event is required.
     */
    LM_EV_LONG_TERM_KEY_REQUESTED,

    /*! \brief Not visible to applications */
     ...
     *  of the Bluetooth v4.0 specification for more information on pairing.
     ...
     *  3 Part H section 2.1 of the Bluetooth v4.0 specification.
