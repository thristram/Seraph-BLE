...
#endif
{
    ...
    /*! \name Security Key Manager Status Codes
     * @{
     */
    skm_status_key_not_found = STATUS_GROUP_SKM,
                                            /*!< No key was found for the given device address */
    skm_status_storage_full,                /*!< The security key store is full */
    skm_status_too_many_keys,               /*!< The NVM Store is not large enough to store the requested keys */
    /*! @} */
    ...
    gatt_status_app_mask = STATUS_GROUP_GATT+0x80,
                                             ...
                                             *   codes in the range 0x80 - 0xFF to ensure they are
    ...
    gatt_status_app_last_code  = STATUS_GROUP_GATT+0xFF,
